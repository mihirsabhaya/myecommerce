...
module.exports = {
  myapi: () => {
    ...
    app.get("/editproduct/:_id", checksession.session, controller.editproduct );
    ...
    app.post("/editproduct/:_id",checksession.session, controller.editproduct );
  ...
  app.get("/myurl" , controller.myurl)
